...
- `internal/provision/live/client.go` `ServiceClient.Get/List`: fill `Project` from a `bifrost-compute.dev/project` label stamped by `RayServiceFor` (add `ProjectLabel` constant).
